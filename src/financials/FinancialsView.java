...
public class FinancialsView extends FrameView {
    ...
    private void jbtnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCalcActionPerformed
        ...
        try {
            ...
            statusMessageLabel.setText("Amount value error: "+ e.getMessage());
            return;
        }
        ...
        try {
            ...
            statusMessageLabel.setText("Rate values error: "+ e.getMessage());
            return;
        }
        try {
            ...
            statusMessageLabel.setText("Term values error: "+ e.getMessage());
            return;
        }
        ...
        if(!f.getEmsg().isEmpty()){
            statusMessageLabel.setText("Error: "+f.getEmsg());
        }else{
